        ...
        const popdensity = [{color: '#feedde', text: "< 10"}, {color: '#fdd0a2', text: "10"}, {color: '#fdae6b', text: "20"}, {color: '#fd8d3c', text: "50"}, {color: '#f16913', text: "100"}, {color: '#d94801', text: "200"}, {color: '#8c2d04', text: "> 1000"}]
